...
const Footer = ({ className }: IFooterProps) => {
    ...
    return (
        <footer className={cn("bg-primary text-background", className)}>
                ...
                <div className="py-[calc(10vh+5rem)] grid lg:grid-cols-[2fr_1fr_1.5fr] lg:gap-0 gap-8">
                    <div className="flex flex-col gap-y-12">
                        <Link href="/" className="w-fit">
                            <Image
                                src={LogoWhite}
                                alt="Row & Harmony Logo"
                                className="w-62.5 h-15 object-cover"
                            />
                        </Link>
                        <ul className="flex flex-col gap-y-2">
                            {contactDetails.map(
                                ({ href, Icon, name, label }, index) => (
                                    <Link
                                        key={name + index}
                                        href={href}
                                    ...
                                    >
                                        ...
                                        <li className="relative before-hover-transform-link">
                                            {label}
                                        </li>
                                    </Link>
                                ),
                                ...
                                index === 1 ? (
                                    <Fragment key={name + index}>
                                        <Link
                                            ...
                                            href={href}
                                            className={cn(
                                                "before-hover-transform-link w-fit",
                                                {
                ...
                <div className="flex md:flex-row flex-col items-center justify-between md:gap-0 gap-6 py-[5vh]">
                    <p className="text-fluid-xs md:text-left text-center">
                        ...
                        <span className="font-medium">
                            ...
                            <span className="text-accent">Row & Harmony</span>{" "}
                            Facility and Property Management Company Ltd.
                        </span>{" "}
                        All Rights Reserved.
                    </p>
                    <Socials />
