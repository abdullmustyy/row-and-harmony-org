...
const OurService = ({ services }: IOurServiceProps) => {
    return (
        <section className="md:py-[10vh] py-[8vh] bg-background relative z-20">
            <div className="container lg:space-y-16 space-y-12">
                <div className="space-y-8">
                    ...
                    <div className="lg:px-12 flex lg:flex-row flex-col lg:gap-8 gap-6 items-start">
                        <h2 className="text-fluid-3xl font-medium font-primary lg:text-right text-left lg:whitespace-nowrap">
                            ...
                            <br className="lg:inline hidden" /> for a Better
                            Tomorrow
                        </h2>
                        <div className="lg:border-l-3 border-accent lg:pl-3">
                            <p className="text-left text-fluid-sm">
                                At Row & Harmony Limited, we provide a diverse
                                range of services designed to keep your
                                facilities running efficiently and your business
                                thriving. Our expertise spans multiple
                                industries, ensuring tailored solutions for
                                every client.
                            </p>
                        </div>
                    </div>
