...
const Hero = () => {
    ...
    return (
        ...
        >
            <div className="group sticky top-nav h-[calc(100vh-var(--spacing-nav))] w-full">
                <div className="container relative flex items-center h-full">
                    <div className="text-background space-y-8">
                        <div className="space-y-2 ">
                            ...
                            <p className="text-fluid-base">
                                Premium Facility Management Solutions for
                                Efficiency,
                    ...
                    >
                        {muted ? (
                            <VolumeOff className="md:size-5 size-4" />
                        ) : (
                            <Volume2 className="md:size-5 size-4" />
                        )}
                    </Button>
                </div>
                ...
                >
                    <source
                        src="/videos/mp4s/randh-advert.mp4"
                        type="video/mp4"
                    />
