...
const WhyChooseUs = () => {
    return (
        <section className="md:py-[10vh] py-[8vh] bg-background relative z-20">
            <div className="container lg:space-y-6 space-y-12">
                <SectionLabel>
                    <p>Why Choose Us</p>
                </SectionLabel>
                    ...
                    <div className="space-y-10 lg:w-1/2">
                        <div className="space-y-4">
                            <h2 className="text-fluid-3xl font-medium font-primary">
                                Excellence in Every Detail — Your Trusted
                                Partner in Facility Management
                            </h2>
                            <p className="text-fluid-sm">
                                At Row & Harmony Limited, we don&apos;t just
                                manage facilities—we optimize, enhance, and
                                future-proof them. Our expertise ensures that
                                your spaces remain functional, safe, and
                                efficient at all times. Here&apos;s why we stand
                                out:
                            </p>
                        </div>
                        <EmblaCarousel
                            ...
                            slides={whyChooseUs.map(
                                ({ Icon, image, description, name }, i) => (
                                    <WhyChooseUsSlide
                                        key={name + i}
                                        {...{ Icon, image, description, name }}
                                    />
                                ),
                            )}
                        />
