...
type ITimeScheduleIconProps = SVGProps<SVGSVGElement>;

const TimeScheduleIcon = ({ className, ...rest }: ITimeScheduleIconProps) => {
    return (
        <svg
            ...
            {...rest}
        >
            <path d="M12 8V12L13.5 13.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
            <path
