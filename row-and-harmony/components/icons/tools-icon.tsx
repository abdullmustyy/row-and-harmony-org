...
type IToolsIconProps = SVGProps<SVGSVGElement>;

const ToolsIcon = ({ className, ...rest }: IToolsIconProps) => {
    return (
        <svg
            ...
            {...rest}
        >
            <path d="M13 11L18 6" stroke="currentColor" />
            <path d="M19 7L17 5L19.5 3.5L20.5 4.5L19 7Z" stroke="currentColor" strokeLinejoin="round" />
            <path
