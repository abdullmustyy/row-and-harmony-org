...
export type AllSanitySchemaTypes = Service | Property | NewsLetter | Job | Client | Icon | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Variable: getFirstThreeServicesQuery
// Query: *[_type == 'service'][0...3]
export type GetFirstThreeServicesQueryResult = Array<{
  _id: string;
  _type: "service";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: getEmailQuery
// Query: *[_type == 'newsLetter' && email == $email][0]{email}
export type GetEmailQueryResult = {
  email: string | null;
} | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == 'service'][0...3]": GetFirstThreeServicesQueryResult;
    "*[_type == 'service']": GetServicesQueryResult;
    "*[_type == 'service' && _id == $id]": GetServiceByIdQueryResult;
    "*[_type == 'newsLetter' && email == $email][0]{email}": GetEmailQueryResult;
  }
}
